# Data Scientist Job Market Analysis (2023–2025) — Python

This project analyzes **real-world data job postings** with a focus on **Data Scientist** roles. The goal is to understand what employers ask for most often (skills), how demand shifts over time, how salary distributions look across roles, and which skills sit at the best intersection of **pay + opportunity**.

As additional market context, I also compare the **top 3 most common data roles** in the dataset.
...
0. How do I clean and standardize the raw dataset into an analysis-ready form? [00_data_preparation_cleaning.ipynb](notebooks/00_data_preparation_cleaning.ipynb)
1. What does the dataset look like at a high level (roles, countries, platforms, companies, and basic job “opportunity” flags)? [01_exploratory_data_analysis.ipynb](notebooks/01_exploratory_data_analysis.ipynb)
2. What are the skills most in demand for the top 3 most popular data roles? [02_skill_demand.ipynb](notebooks/02_skill_demand.ipynb)
3. How are in-demand skills trending for Data Scientists over time? [03_skills_trend.ipynb](notebooks/03_skills_trend.ipynb)
4. How well do jobs and skills pay for Data Scientists? [04_salary_analysis.ipynb](notebooks/04_salary_analysis.ipynb)
5. What are the optimal skills for Data Scientists to learn (high demand AND high paying)? [05_optimal_skills.ipynb](notebooks/05_optimal_skills.ipynb)
...
[00_data_preparation_cleaning.ipynb](notebooks/00_data_preparation_cleaning.ipynb)
...
Note: `job_no_degree_mention` captures cases where the posting **explicitly states** that a degree is not required. If it’s False, it does not necessarily mean a degree is required — it may simply not be mentioned.

[01_exploratory_data_analysis.ipynb](notebooks/01_exploratory_data_analysis.ipynb)

#### Results

<img src="images/job_postings_by_role.png" width="800" alt="Job Postings by Role">

*Distribution of job postings across the most common roles.*

<img src="images/job_postings_by_country.png" width="800" alt="Job Postings by Country">

*Countries contributing the highest number of job postings.*

<img src="images/job_postings_by_platform.png" width="800" alt="Job Postings by Platform">

*Most common posting sources (`job_via`) after standardizing frequent platform labels (e.g., LinkedIn/Indeed/BeBee).*

<img src="images/job_postings_by_employer.png" width="800" alt="Job Postings by Employer">
...
<img src="images/job_opportunities.png" width="800" alt="Job Opportunity Flags">
...
<img src="images/likelihood_of_skills_requested_in_global_job_postings.png" width="800" alt="Likelihood of Skills Requested in Global Job Postings">
...
[03_skills_trend.ipynb](notebooks/03_skills_trend.ipynb)

#### Results

<img src="images/trending_top_skills_for_data_scientists_by_quarter.png" width="800" alt="Trending Top Skills for Data Scientists by Quarter">
...
[04_salary_analysis.ipynb](notebooks/04_salary_analysis.ipynb)

---

### 4A. Salary distributions by role

#### Results

<img src="images/salary_distributions_of_data_jobs.png" width="800" alt="Salary Distributions of Data Jobs">

<img src="images/salary_distributions_of_data_jobs_closer_look.png" width="800" alt="Salary Distributions of Data Jobs (Closer Look)">
...
### 4B. Highest-paid vs most in-demand skills (Data Scientist)

#### Results

<img src="images/highest_paid_vs_most_in_demand_skills_for_data_scientists.png" width="800" alt="Highest Paid vs Most In-Demand Skills for Data Scientists">
...
[05_optimal_skills.ipynb](notebooks/05_optimal_skills.ipynb)

#### Results

<img src="images/most_optimal_skills_for_data_scientists.png" width="800" alt="Most Optimal Skills for Data Scientists">
